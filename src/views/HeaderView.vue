  ...
  <header>
    ...
    <nav>
      ...
      <ul class="right_nav">
        <li class="menu">
          <ul>
            <li><a href="./menu.html">생초콜릿</a>
              <ul class="sub_menu">
                <li><a href="#">다크</a></li>
                <li><a href="#">다크+밀크</a></li>
              </ul>
            </li>

            <li><a href="./menu2.html">초콜릿</a>
              <ul class="sub_menu">
                <li><a href="#" class="hover-underline">말차</a></li>
                <li><a href="#" class="hover-underline">초콜릿</a></li>
              </ul>
            </li>
          </ul>
        </li>
